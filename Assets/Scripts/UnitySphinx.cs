...
public class UnitySphinx : MonoBehaviour {
	...
	public static void Init() {
        ...
        hmm = Application.dataPath + "/Resources/UnitySphinx/model/aymara/aymara-hmm";
        lm = Application.dataPath + "/Resources/UnitySphinx/model/aymara/aymara.lm";
        dict = Application.dataPath + "/Resources/UnitySphinx/model/aymara/aymara.dic";

        jsgf = Application.dataPath + "/Resources/UnitySphinx/model/aymara/ordenes1.gram";
        kws = Application.dataPath + "/Resources/UnitySphinx/model/aymara/keyphrase.list";
